...
const navItems = [
  ...
  { icon: StretchHorizontal, label: 'Spacing' }, // Added Spacing
...
// ** THIS IS THE CHANGE: Added onClick and active prop **
...
// ** THIS IS THE CHANGE: Added activePage and onNavigate props **
